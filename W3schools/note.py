...
#find()	        the string for a specified value and returns the position of where it was found
...
# Import math 
# có thể sử dụng các phép toán phức tạp trong toán học
# Ceil (Trần nhà) tìm số nhỏ nhớ không bé hơn số đã cho
# Floor (Sàn nhà) tìm số lớn nhớ không lớn hơn số đã cho 

# Import os
# có thể sử dụng các hàm để làm việc với hệ điều hành (Tập tin và thư mục)



# Import sys
# có thể sử dụng các hàm để làm việc với hệ thống
